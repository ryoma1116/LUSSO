        ...
        <div class="news__inner">
            <div class="news__side">
                <aside class="news__nav news-nav" data-aos="fade-up" data-aos-duration="1000">
                    <ul class="news-nav__list js-sticky">
                        ...
                        <li class="news-nav__item js-news-nav <?php if (is_category('topix')) : ?>is-active<?php endif; ?>">
                            <a href="<?php echo esc_url(home_url('/')); ?>category/topix" class="news-nav__link">トピックス</a>
                        </li>
                        <li class="news-nav__item js-news-nav <?php if (is_category('event')) : ?>is-active<?php endif; ?>">
                            <a href="<?php echo esc_url(home_url('/')); ?>category/event" class="news-nav__link">イベント・キャンペーン</a>
                        </li>
                        <li class="news-nav__item js-news-nav <?php if (is_category('warehousing')) : ?>is-active<?php endif; ?>">
            ...
            <div class="news__post">
                ...
                if ($wp_query->have_posts()) : while ($wp_query->have_posts()) :
                        $wp_query->the_post();
                ?>
                        <article class="news__article news-article" data-aos="fade-up" data-aos-duration="1000">
                            <a href="<?php the_permalink(); ?>">
                                ...
                                <h3 class="news-article__title"><?php the_title(); ?></h3>
                            </a>
                        </article>
                    <?php endwhile;
                else : ?>
